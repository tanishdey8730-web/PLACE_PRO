...
export default function CareerCoachChatPage() {
      ...
      setMessages([
        {
          ...
          role: "assistant",
          content:
            "Hi! I'm your AI Career Coach. Ask me about skills, technologies, learning paths, or placement strategy.",
  ...
  async function sendMessage(text?: string) {
    ...
    const res = await api<{ sessionId: string; reply: string; message: CareerCoachMessage }>(
      ...
      {
        method: "POST",
        body: JSON.stringify({ action: "chat", sessionId, message: msg, targetRole }),
      }
    );
    ...
    if (res.success && res.data) {
      ...
      setMessages((m) => [
        ...m,
        {
          id: `err-${Date.now()}`,
          role: "assistant",
          content: "Could you rephrase your question? I'm here to help with career guidance.",
          createdAt: new Date().toISOString(),
        },
      ]);
    }
      ...
      <main className="p-4 lg:p-8 max-w-6xl mx-auto pb-24 lg:pb-8">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div>
            ...
            <p className="text-muted-foreground mt-1">Live coaching for skills, tech stack & strategy</p>
          </div>
        ...
        <div className="grid lg:grid-cols-5 gap-6">
          ...
          <div className="lg:col-span-2 space-y-4">
            {insights ? (
              <>
                <InsightCard icon={Target} title="Career Guidance" content={insights.careerGuidance} />
                <InsightCard icon={Code2} title="Skill Recommendations" items={insights.skillRecommendations} />
                <InsightCard icon={Cpu} title="Technology Recommendations" items={insights.technologyRecommendations} />
                <Card>
                ...
                <InsightCard icon={Briefcase} title="Placement Strategy" items={insights.placementStrategy} />
              </>
            ) : (
